      ...
      data: structureTypes.map((s, i) => ({
        ...
        itemStyle: {
          color: new echarts.graphic.LinearGradient(0, 0, 1, 1, [
            { offset: 0, color: ['#D2B48C', '#B0C4DE', '#90EE90', '#DAA520', '#CD5C5C'][i] },
            { offset: 1, color: ['#BC8F8F', '#708090', '#70C1B3', '#B8860B', '#BC8F8F'][i] },
          ])
        },
      })),
      emphasis: {
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div className="flex gap-2">
                        <span className="text-[10px] px-2 py-0.5 bg-blue-900/30 text-blue-300 rounded font-semibold">{s.region}</span>
                        <span className="text-[10px] px-2 py-0.5 bg-amber-900/30 text-amber-300 rounded font-semibold">{s.advantage}</span>
                      </div>
                    </div>
