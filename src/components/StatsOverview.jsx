...
const stats = [
  ...
  { label: '世界文化遗产', value: 20, suffix: '处', icon: '🏛️', color: 'from-emerald-600/20 to-emerald-800/10' },
          ...
          <div className="card-glass p-7 group cursor-default">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-ink">{summaryStats.oldestBuilding}</p>
          ...
          <div className="card-glass p-7 group cursor-default">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-ink">{summaryStats.largestBuilding}</p>
