  ...
  return (
    <div className="flex items-center justify-center h-[500px]">
      <div className="text-center">
        <div className="w-10 h-10 border border-[#ffd700]/30 border-t-[#ffd700] rounded-full animate-spin mx-auto mb-4" />
        <p className="text-[#b0b0b0] text-xs tracking-widest uppercase">加载3D场景</p>
      </div>
    </div>
  )
}
...
function SectionDivider({ title, index = 0 }) {
  return (
    <div className="py-12 md:py-16 flex items-center gap-6 max-w-6xl mx-auto px-8">
      <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#ffd700]/20 to-transparent" />
      {title && (
        <div className="flex items-center gap-3">
          <div className="w-1 h-1 rounded-full bg-[#ffd700]/40" />
          <span className="text-[10px] text-[#ffd700]/40 tracking-[0.4em] uppercase whitespace-nowrap font-light">{title}</span>
          <div className="w-1 h-1 rounded-full bg-[#ffd700]/40" />
        </div>
      )}
      <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#ffd700]/20 to-transparent" />
